.. mograph documentation master file, created by
   sphinx-quickstart on Tue Mar 24 01:21:59 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to mograph's documentation!
===================================
...
.. toctree::
   ...
   pages/graph-analysis
   pages/tooling
   pages/testing-methodology
   pages/continuous-integration
